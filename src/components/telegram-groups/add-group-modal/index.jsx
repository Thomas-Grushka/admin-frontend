...
const AddGroupModal = ({open, handleClose, onSubmit, defaultValues}) => {
  const [formValues, setFormValues] = useState(defaultValues || formDefaultValues);
  ...
  return (
    ...
    >
      ...
      <DialogActions>
        ...
        <Button type="submit" onClick={handleSubmit}>Add group</Button>
      </DialogActions>
    </Dialog>
  );
};
